...
async function seed() {
    console.log(...oo_oo(`1610594546_34_2_34_48_4`, '🌱 Starting database seeding...'));
    try {
        console.log(...oo_oo(`1610594546_38_4_38_47_4`, '🧹 Clearing existing data...'));
        ...
        console.log(...oo_oo(`1610594546_50_4_50_42_4`, '✅ Existing data cleared'));
        const modulesData = [
        ...
        console.log(...oo_oo(`1610594546_67_4_67_36_4`, '✅ Modules created'));
        ...
        console.log(...oo_oo(`1610594546_115_4_115_40_4`, '✅ Permissions created'));
        const rolesData = [
        ...
        console.log(...oo_oo(`1610594546_126_4_126_34_4`, '✅ Roles created'));
        ...
        console.log(...oo_oo(`1610594546_193_4_193_34_4`, '✅ Users created'));
        const projectsData = [
            {
        ...
        console.log(...oo_oo(`1610594546_207_4_207_37_4`, '✅ Projects created'));
        const teamsData = [
            {
                name: 'Mobile Team',
        ...
        console.log(...oo_oo(`1610594546_233_4_233_34_4`, '✅ Teams created'));
        const userRolesData = [
        ...
        console.log(...oo_oo(`1610594546_247_4_247_40_4`, '✅ User roles assigned'));
        ...
        if (developerRole) {
            const dailyUpdatePermissions = createdPermissions.filter(p => (p.name.includes('DAILY_UPDATES') && !p.name.includes('FULL')) ||
        ...
        console.log(...oo_oo(`1610594546_303_4_303_46_4`, '✅ Role permissions assigned'));
        ...
        console.log(...oo_oo(`1610594546_317_4_317_47_4`, '✅ Users assigned to projects'));
        const userTeamsData = [
        ...
        console.log(...oo_oo(`1610594546_329_4_329_44_4`, '✅ Users assigned to teams'));
        ...
        console.log(...oo_oo(`1610594546_394_4_394_49_4`, '✅ Sample daily updates created'));
        console.log(...oo_oo(`1610594546_396_4_396_62_4`, '🎉 Database seeding completed successfully!'));
        console.log(...oo_oo(`1610594546_397_4_397_19_4`, ''));
        console.log(...oo_oo(`1610594546_398_4_398_40_4`, '📋 Project Structure:'));
        console.log(...oo_oo(`1610594546_399_4_399_54_4`, '1. Singlife Project (SINGLIFE-2025)'));
        console.log(...oo_oo(`1610594546_400_4_400_65_4`, '   - Manager: Bala Manager (bala@singlife.com)'));
        console.log(...oo_oo(`1610594546_401_4_401_70_4`, '   - Team Lead: Ashok TeamLead (ashok@singlife.com)'));
        console.log(...oo_oo(`1610594546_402_4_402_72_4`, '   - Mobile Team: Shyaam Mobile (shyaam@singlife.com)'));
        console.log(...oo_oo(`1610594546_403_4_403_104_4`, '   - Web App Team: Sujan WebApp (sujan@singlife.com), Anbu WebApp (anbu@singlife.com)'));
        console.log(...oo_oo(`1610594546_404_4_404_74_4`, '   - TechOps Team: Harish TechOps (harish@singlife.com)'));
        console.log(...oo_oo(`1610594546_405_4_405_19_4`, ''));
        console.log(...oo_oo(`1610594546_406_4_406_53_4`, '🔑 Sample credentials (all users):'));
        console.log(...oo_oo(`1610594546_407_4_407_62_4`, 'Email: [user-email] / Password: password123'));
        console.log(...oo_oo(`1610594546_408_4_408_19_4`, ''));
        console.log(...oo_oo(`1610594546_409_4_409_43_4`, '📊 Permission Structure:'));
        console.log(...oo_oo(`1610594546_410_4_410_88_4`, '- Bala (Manager): All permissions (including VIEW_DAILY_UPDATES_FULL)'));
        console.log(...oo_oo(`1610594546_411_4_411_91_4`, '- Ashok (Team Lead): All permissions (including VIEW_DAILY_UPDATES_FULL)'));
        console.log(...oo_oo(`1610594546_412_4_412_108_4`, '- Developers: Only basic daily update permissions (VIEW_DAILY_UPDATES - own updates only)'));
        console.log(...oo_oo(`1610594546_413_4_413_19_4`, ''));
        console.log(...oo_oo(`1610594546_414_4_414_42_4`, '🔍 Daily Update Access:'));
        console.log(...oo_oo(`1610594546_415_4_415_84_4`, '- VIEW_DAILY_UPDATES_FULL: Can see all updates across the project'));
        console.log(...oo_oo(`1610594546_416_4_416_71_4`, '- VIEW_DAILY_UPDATES: Can only see their own updates'));
        console.log(...oo_oo(`1610594546_417_4_417_19_4`, ''));
        console.log(...oo_oo(`1610594546_418_4_418_48_4`, '🧪 Test the Permission Logic:'));
        console.log(...oo_oo(`1610594546_419_4_419_70_4`, '1. Login as Bala (Manager) - should see all updates'));
        console.log(...oo_oo(`1610594546_420_4_420_79_4`, '2. Login as Shyaam (Developer) - should only see own updates'));
        console.log(...oo_oo(`1610594546_421_4_421_79_4`, '3. Try filtering by userId - Managers can, Developers cannot'));
        console.log(...oo_oo(`1610594546_422_4_422_64_4`, '4. Check logs for permission decision details'));
    }
    catch (error) {
        console.error(...oo_tx(`1610594546_425_4_425_51_11`, '❌ Error during seeding:', error));
        throw error;
    }
    finally {
        await pool.end();
...
seed().catch((error) => {
    console.error(...oo_tx(`1610594546_433_2_433_38_11`, 'Seed failed:', error));
    process.exit(1);
});
;
function oo_cm() { try {
