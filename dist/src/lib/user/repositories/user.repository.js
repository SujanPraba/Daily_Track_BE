...
let UserRepository = class UserRepository {
    ...
    async findUserWithCompleteInformation(userId) {
        console.log(...oo_oo(`1208248865_368_4_368_78_4`, 'findUserWithCompleteInformation called with userId:', userId));
        try {
            const [user] = await this.db.select().from(user_schema_1.users).where((0, drizzle_orm_1.eq)(user_schema_1.users.id, userId));
            console.log(...oo_oo(`1208248865_372_6_372_38_4`, 'User found:', user));
            if (!user) {
                console.log(...oo_oo(`1208248865_375_8_375_52_4`, 'No user found, returning null'));
                return null;
            }
            ...
            console.log(...oo_oo(`1208248865_418_6_418_58_4`, 'User projects data:', userProjectsData));
            ...
            console.log(...oo_oo(`1208248865_438_6_438_52_4`, 'User teams data:', userTeamsData));
            ...
            console.log(...oo_oo(`1208248865_513_6_513_58_4`, 'Processed projects:', userProjectsList));
            ...
            console.error(...oo_tx(`1208248865_526_6_526_71_11`, 'Error in findUserWithCompleteInformation:', error));
            throw error;
        }
    }
};
