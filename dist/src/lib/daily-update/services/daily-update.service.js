...
let DailyUpdateService = class DailyUpdateService {
    ...
    async searchDailyUpdates(searchDto, currentUserId) {
        console.log(...oo_oo(`479913943_146_4_146_89_4`, `🔍 Search request from user ${currentUserId} with criteria:`, searchDto));
        ...
        console.log(...oo_oo(`479913943_160_4_160_129_4`, `🔐 User permissions - VIEW_DAILY_UPDATES_FULL: ${hasFullPermission}, VIEW_DAILY_UPDATES: ${hasBasicPermission}`));
        if (!hasBasicPermission && !hasFullPermission) {
            console.log(...oo_oo(`479913943_163_6_163_84_4`, `❌ User ${currentUserId} has no permission to view daily updates`));
            return {
                data: [],
                total: 0,
        ...
        console.log(...oo_oo(`479913943_180_4_180_79_4`, `📋 User ${currentUserId} has access to projects:`, projectIds));
        if (projectIds.length === 0) {
            console.log(...oo_oo(`479913943_184_6_184_69_4`, `❌ User ${currentUserId} has no projects assigned`));
            return {
                data: [],
                total: 0,
                page: searchDto.page || 1,
        ...
        if (searchDto.userId) {
            if (hasFullPermission) {
                ...
                console.log(...oo_oo(`479913943_204_8_204_100_4`, `✅ User with VIEW_DAILY_UPDATES_FULL can filter by userId: ${searchDto.userId}`));
            }
            else {
                searchCriteria.userId = currentUserId;
                console.log(...oo_oo(`479913943_209_8_209_133_4`, `⚠️ User with only VIEW_DAILY_UPDATES - ignoring requested userId ${searchDto.userId}, showing own updates only`));
            }
        }
        else if (!hasFullPermission) {
            searchCriteria.userId = currentUserId;
            console.log(...oo_oo(`479913943_215_6_215_94_4`, `🔒 User without VIEW_DAILY_UPDATES_FULL - restricting to own updates only`));
        }
        if (searchDto.projectId) {
            if (!hasFullPermission && !projectIds.includes(searchDto.projectId)) {
                console.log(...oo_oo(`479913943_223_8_223_112_4`, `❌ User ${currentUserId} tried to access project ${searchDto.projectId} without permission`));
                return {
                    data: [],
                    total: 0,
                    page: searchDto.page || 1,
            ...
            console.log(...oo_oo(`479913943_235_6_235_69_4`, `✅ Project filter applied: ${searchDto.projectId}`));
        }
        else if (!hasFullPermission) {
            searchCriteria.projectId = projectIds;
            console.log(...oo_oo(`479913943_240_6_240_67_4`, `🔒 Restricting to user's projects:`, projectIds));
        }
        if (searchDto.teamId) {
            searchCriteria.teamId = searchDto.teamId;
            console.log(...oo_oo(`479913943_247_6_247_63_4`, `✅ Team filter applied: ${searchDto.teamId}`));
        }
        if (searchDto.status) {
            searchCriteria.status = searchDto.status;
            console.log(...oo_oo(`479913943_252_6_252_65_4`, `✅ Status filter applied: ${searchDto.status}`));
        }
        if (searchDto.tickets) {
            searchCriteria.tickets = searchDto.tickets;
            console.log(...oo_oo(`479913943_257_6_257_67_4`, `✅ Tickets filter applied: ${searchDto.tickets}`));
        }
        if (searchDto.startDate && searchDto.endDate) {
            ...
            console.log(...oo_oo(`479913943_263_6_263_96_4`, `✅ Date range filter applied: ${searchDto.startDate} to ${searchDto.endDate}`));
        }
        console.log(...oo_oo(`479913943_266_4_266_60_4`, `🔍 Final search criteria:`, searchCriteria));
        console.log(...oo_oo(`479913943_267_4_267_125_4`, `🔐 Permission summary - hasFullPermission: ${hasFullPermission}, hasBasicPermission: ${hasBasicPermission}`));
        console.log(...oo_oo(`479913943_268_4_268_64_4`, `📋 User project IDs: ${projectIds.join(', ')}`));
        const page = searchDto.page || 1;
        const limit = searchDto.limit || 10;
        const offset = (page - 1) * limit;
        console.log(...oo_oo(`479913943_274_4_274_84_4`, `📄 Pagination - page: ${page}, limit: ${limit}, offset: ${offset}`));
        ...
        console.log(...oo_oo(`479913943_282_4_282_78_4`, `📊 Raw data count: ${rawData.length}, Total count: ${total}`));
        if (rawData.length > 0) {
            console.log(...oo_oo(`479913943_284_6_289_8_4`, `📝 Sample raw data:`, {
                id: rawData[0].id,
        ...
        if (hasFullPermission) {
            ...
            console.log(...oo_oo(`479913943_300_6_300_111_4`, `👁️ VIEW_DAILY_UPDATES_FULL: Showing ${filteredData.length} updates across user's projects`));
        }
        else {
            filteredData = rawData.filter(item => item.userId === currentUserId);
            console.log(...oo_oo(`479913943_306_6_306_113_4`, `👤 VIEW_DAILY_UPDATES: Showing ${filteredData.length} updates for user ${currentUserId} only`));
        }
        ...
        console.log(...oo_oo(`479913943_339_4_339_108_4`, `✅ Search completed - Returning ${filteredData.length} results, page ${page}/${totalPages}`));
        return {
            data,
    ...
    async getTimeTracking(timeTrackingDto, currentUserId) {
        ...
        console.log(...oo_oo(`479913943_388_4_388_112_4`, 'Getting time tracking with criteria:', { projectId, teamId, startDate, endDate, filterTimeBy }));
        console.log(...oo_oo(`479913943_389_4_389_50_4`, 'Current user ID:', currentUserId));
        ...
        console.log(...oo_oo(`479913943_398_4_398_72_4`, 'Using date range:', { searchStartDate, searchEndDate }));
        const hasFullPermission = await this.userService.hasPermission(currentUserId, 'VIEW_DAILY_UPDATES_FULL');
        console.log(...oo_oo(`479913943_406_4_406_82_4`, 'User has VIEW_DAILY_UPDATES_FULL permission:', hasFullPermission));
        let userProjectIds = [];
        userProjectIds = await this.userService.getUserProjectIds(currentUserId);
        console.log(...oo_oo(`479913943_412_4_412_52_4`, 'User project IDs:', userProjectIds));
        if (userProjectIds.length === 0) {
            console.log(...oo_oo(`479913943_416_6_416_50_4`, 'User has no projects assigned'));
            return [];
        }
        ...
        if (!projectId) {
            ...
            console.log(...oo_oo(`479913943_427_6_427_66_4`, 'Restricting to user project:', searchProjectId));
        }
        if (projectId && !userProjectIds.includes(projectId)) {
            console.log(...oo_oo(`479913943_432_6_432_67_4`, 'User does not have access to specified project'));
            return [];
        }
        ...
        console.log(...oo_oo(`479913943_444_4_444_84_4`, 'Raw daily updates from DB:', JSON.stringify(dailyUpdates, null, 2)));
        if (!dailyUpdates || dailyUpdates.length === 0) {
            console.log(...oo_oo(`479913943_447_6_447_66_4`, 'No daily updates found for the given criteria'));
            return [];
        }
        let filteredUpdates = dailyUpdates;
        if (hasFullPermission) {
            filteredUpdates = dailyUpdates.filter(update => userProjectIds.includes(update.projectId));
            console.log(...oo_oo(`479913943_459_6_459_109_4`, 'Full permission: showing all updates under user projects, count:', filteredUpdates.length));
        }
        else {
            filteredUpdates = dailyUpdates.filter(update => update.userId === currentUserId);
            console.log(...oo_oo(`479913943_465_6_465_98_4`, 'Limited permission: showing only user updates, count:', filteredUpdates.length));
        }
