...
let DailyUpdateController = class DailyUpdateController {
    ...
    async getTimeTracking(timeTrackingDto, req) {
        console.log(...oo_oo(`1278299410_146_4_146_58_4`, 'Time tracking request:', timeTrackingDto));
        const userId = req.user?.userId;
        if (!userId) {
            throw new Error('User ID not found in token');
        }
        const result = await this.dailyUpdateService.getTimeTracking(timeTrackingDto, userId);
        console.log(...oo_oo(`1278299410_155_4_155_73_4`, 'Time tracking result:', JSON.stringify(result, null, 2)));
        return result;
    }
    async testDbContent(req) {
        ...
        console.log(...oo_oo(`1278299410_170_4_170_74_4`, 'All daily updates:', JSON.stringify(allUpdates, null, 2)));
        const userProjectIds = await this.dailyUpdateService.getUserProjectIds(userId);
        console.log(...oo_oo(`1278299410_174_4_174_52_4`, 'User project IDs:', userProjectIds));
        const hasFullPermission = await this.dailyUpdateService.hasPermission(userId, 'VIEW_DAILY_UPDATES_FULL');
        console.log(...oo_oo(`1278299410_178_4_178_82_4`, 'User has VIEW_DAILY_UPDATES_FULL permission:', hasFullPermission));
        const teams = await this.dailyUpdateService.getTeamByProject('any-project-id');
        console.log(...oo_oo(`1278299410_182_4_182_57_4`, 'Teams:', JSON.stringify(teams, null, 2)));
        return {
    ...
    async testSearchPermissions(req) {
        ...
        console.log(...oo_oo(`1278299410_203_4_203_68_4`, `🔍 Testing search permissions for user: ${userId}`));
        const hasFullPermission = await this.dailyUpdateService.hasPermission(userId, 'VIEW_DAILY_UPDATES_FULL');
        ...
        console.log(...oo_oo(`1278299410_218_4_218_62_4`, `🧪 Testing search with criteria:`, searchDto));
