...
const zoho_sync_daily_update_dto_1 = require("../dtos/zoho-sync-daily-update.dto");
...
let DailyUpdateController = class DailyUpdateController {
    ...
    createWithZohoSync(zohoSyncDto) {
    ...
    async getTimeTracking(timeTrackingDto, req) {
        console.log(...oo_oo(`241357906_176_4_176_58_4`, 'Time tracking request:', timeTrackingDto));
        const userId = req.user?.userId;
        if (!userId) {
            throw new Error('User ID not found in token');
        }
        const result = await this.dailyUpdateService.getTimeTracking(timeTrackingDto, userId);
        console.log(...oo_oo(`241357906_185_4_185_73_4`, 'Time tracking result:', JSON.stringify(result, null, 2)));
        return result;
    }
    async testDbContent(req) {
        ...
        console.log(...oo_oo(`241357906_200_4_200_74_4`, 'All daily updates:', JSON.stringify(allUpdates, null, 2)));
        const userProjectIds = await this.dailyUpdateService.getUserProjectIds(userId);
        console.log(...oo_oo(`241357906_204_4_204_52_4`, 'User project IDs:', userProjectIds));
        const hasFullPermission = await this.dailyUpdateService.hasPermission(userId, 'VIEW_DAILY_UPDATES_FULL');
        console.log(...oo_oo(`241357906_208_4_208_82_4`, 'User has VIEW_DAILY_UPDATES_FULL permission:', hasFullPermission));
        const teams = await this.dailyUpdateService.getTeamByProject('any-project-id');
        console.log(...oo_oo(`241357906_212_4_212_57_4`, 'Teams:', JSON.stringify(teams, null, 2)));
        return {
    ...
    async testSearchPermissions(req) {
        const userId = req.user?.userId;
        if (!userId) {
            throw new Error('User ID not found in token');
        }
        console.log(...oo_oo(`241357906_233_4_233_68_4`, `🔍 Testing search permissions for user: ${userId}`));
        const hasFullPermission = await this.dailyUpdateService.hasPermission(userId, 'VIEW_DAILY_UPDATES_FULL');
        ...
        console.log(...oo_oo(`241357906_248_4_248_62_4`, `🧪 Testing search with criteria:`, searchDto));
...
__decorate([
    ...
    **Zoho Integration:**
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: zoho_sync_daily_update_dto_1.ZohoSyncResponseDto
    }),
    (0, common_1.Post)('zoho-sync'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [zoho_sync_daily_update_dto_1.ZohoSyncDailyUpdateDto]),
    __metadata("design:returntype", void 0)
], DailyUpdateController.prototype, "createWithZohoSync", null);
__decorate([
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Test endpoint to debug search permission issues' }),
    (0, common_1.Get)('test/search-permissions'),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DailyUpdateController.prototype, "testSearchPermissions", null);
__decorate([
...
__decorate([
    ...
    (0, common_1.Get)('zoho/test-connection'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DailyUpdateController.prototype, "testZohoConnection", null);
__decorate([
    (0, swagger_1.ApiOperation)({
    ...
    (0, common_1.Get)('zoho/activity-types'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DailyUpdateController.prototype, "getZohoActivityTypes", null);
