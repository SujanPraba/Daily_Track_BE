...
export const dailyUpdates = pgTable('daily_updates', {
  ...
  ticketsHours: decimal('tickets_hours', { precision: 4, scale: 2 }).default('0.00'),
  ...
  leavePermissionHours: decimal('leave_permission_hours', { precision: 4, scale: 2 }).default('0.00'),
